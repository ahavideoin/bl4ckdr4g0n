...
from bl4ckdr4g0n import dispatcher, LOGGER
...
from bl4ckdr4g0n.modules.helper_funcs.misc import build_keyboard
from bl4ckdr4g0n.modules.helper_funcs.string_handling import split_quotes, button_markdown_parser
from bl4ckdr4g0n.modules.sql import cust_filters_sql as sql
                ...
                try:
                    ...
                    if excp.message == "Unsupported url protocol":
                        message.reply_text("You seem to be trying to use an unsupported url protocol. Telegram "
                                           ...
                                           "again, or ask in @bl4ckdr4g0nAyaGroup for help.")
                        ...
                        message.reply_text("This note could not be sent, as it is incorrectly formatted. Ask in "
                                           "@bl4ckdr4g0nAyaGroup if you can't figure out why!")
